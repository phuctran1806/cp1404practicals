...
last_names_of_longer_than_11_characters_full_names = [name.split()[1] for name in full_names if len(name) > 11]
print(", ".join(last_names_of_longer_than_11_characters_full_names))